...
class RewardComputer:
    ...
    FLIP_THRESHOLD:        float = np.deg2rad(90)  # per-axis limit; raised from 85° — 90° is the knife-edge limit (true inversion starts above this)
    ...
    def compute(
        ...
        #     exceeds FLIP_THRESHOLD (90°).  Because is_terminated() also checks
